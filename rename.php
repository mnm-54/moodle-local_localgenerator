...
foreach ($it as $path) {
    ...
    $file_contents = str_replace("localgenerator", $newname, $file_contents); // oldname, newname
    file_put_contents($path_to_file, $file_contents);
}

// file and folder rename procedure
rename("./lang/en/local_localgenerator.php", "./lang/en/local_" . $newname . ".php");
rename("../moodle-local_localgenerator", "../" . $newname);
